...
## Project Structure
    ...
    ├── throbbing_paper_dev_90891  # Django project configurations
...
1. Clone this repo and `cd throbbing_paper_dev_90891`
...
2. Clone this repo and `cd throbbing_paper_dev_90891`
